...
/**
 * This is the abstract class is subclassed in order to plug in new FEC implementations. If you wish to use the default implementation
 * defined by the property "com.onionnetworks.fec.defaultcodefactoryclass" you should simply call:
 * 
 * <code>
...
public abstract class FECCodeFactory {
    ...
    /**
     * @return The default FECCodeFactory which is defined by the property "com.onionnetworks.fec.defaultcodefactoryclass". If this property
     *         is not defined then DefaultFECCodeFactory will be used by default.
     */
