...
/**
 * This is the default FECCodeFactory that wraps all of the FECCode implementations. It provides a way to customize the codes through a
 * properties file specified by the property "com.onionnetworks.fec.defaultfeccodefactorypropertiesfile". By default it will use the
 * "lib/fec.properties" file distributed with the JAR. Please consult this file for an example of how this should be done.
 * 
 * The properties in this file can also be passed manually to the System properties. Again, consult the provided properties file for an
 * example. This given, if you are adding new codes to this stuff please let me know because I worked my ass of to provide this for you, so
 * do me a favor and at least let me know what you're using this for.
 * 
...
public class DefaultFECCodeFactory extends FECCodeFactory {
    ...
    public DefaultFECCodeFactory() {
        ...
        try {
            ...
            fecProperties.load(ClassLoader.getSystemClassLoader().getResourceAsStream(
                    System.getProperty("com.onionnetworks.fec.defaultfeccodefactorypropertiesfile", "lib/fec.properties")));
        ...
        while (st.hasMoreTokens()) {
            ...
            try {
                Constructor con = Class.forName(getProperty("com.onionnetworks.fec." + key + ".class")).getConstructor(
    ...
    public synchronized FECCode createFECCode(int k, int n) {
        ...
        if (result == null) {
            if (k < 1 || k > 65536 || n < k || n > 65536) {
                throw new IllegalArgumentException("k and n must be between 1 and 65536 and n must not be " + "smaller than k: k=" + k
                        + ",n=" + n);
            }
